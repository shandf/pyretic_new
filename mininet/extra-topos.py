...
class SimplePrefixTopo(Topo):
    def __init__(self):
        ...
        self.addLink('h3','s2',port1=0,port2=0)
        self.addLink('h4','s2',port1=0,port2=1)
        self.addLink('s1','s2')
        
        self.addHost('h21', ip='10.0.1.1')
        self.addHost('h22', ip='10.0.1.2')
        self.addHost('h23', ip='10.0.1.3')
        self.addHost('h24', ip='10.0.1.4')
        self.addSwitch('s21')
        self.addSwitch('s22')
        # Add edges
        self.addLink('h21','s21',port1=0,port2=0)
        self.addLink('h22','s21',port1=0,port2=1)
        self.addLink('h23','s22',port1=0,port2=0)
        self.addLink('h24','s22',port1=0,port2=1)
